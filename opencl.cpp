...
cl::Program loadProgram(cl::Device device, cl::Context context, bool useSavedBinary)
{
    ...
    if (useSavedBinary && doesFileExist(binFileName))
    {
        #ifdef DEBUG
        cout << "Reusing precompiled binary\n";
        #endif // DEBUG
        found = true;
    ...
    {
        #ifdef DEBUG
        cout << "Creating new binary from sources\n";
        #endif // DEBUG
    ...
    #ifdef DEBUG
    outputElapsedSec("Build", start);
    #endif

    if (useSavedBinary && !found)
    {
